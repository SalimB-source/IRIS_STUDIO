      ...
      <main className="art-main">
        ...
        <section className="art-projects" aria-labelledby="home-projects-title">
          ...
          <div className="art-projects-list">
            <LetsPlayProjectLink className="art-project art-project-primary"><div className="art-project-media art-project-media-brand art-project-media-letsplay art-project-media-thumbnail"><img src={partnerProjectBranding.letsPlay.thumbnail} alt={partnerProjectBranding.letsPlay.thumbnailAlt} /><span>01</span><b>IDENTITÉ / CANAL OFFICIEL</b></div><div><p>LET’S PLAY × ALGÉRIE TÉLÉCOM</p><h3>Une émission qui fait dialoguer gaming, culture et technologie.</h3><em>Gaming · Pop culture · Tech</em><b>Découvrir <ArrowUpRight size={17} /></b></div></LetsPlayProjectLink>
            <SevenArenaProjectLink className="art-project art-project-secondary"><div className="art-project-media art-project-media-brand art-project-media-arena art-project-media-thumbnail"><img src={partnerProjectBranding.sevenArena.thumbnail} alt={partnerProjectBranding.sevenArena.thumbnailAlt} /><span>02</span><b>IDENTITÉ / CANAL OFFICIEL</b></div><div><p>7OUMA ARENA × DJEZZY</p><h3>Une scène compétitive pensée avec et pour sa communauté.</h3><em>E-sport · Mobile gaming · Tournois</em><b>Découvrir <ArrowUpRight size={17} /></b></div></SevenArenaProjectLink>
          </div>
        </section>
