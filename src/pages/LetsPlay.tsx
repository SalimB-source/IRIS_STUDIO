...
/**
 * Direction Let’s Play : une scène violet gaming associant grille, micro-icônes et lisibilité éditoriale, sans perdre les archives officielles.
 * Chaque média conserve sa provenance publique, sa légende et un repère de campagne clair.
 */
import { useEffect, useState } from "react";
import { ArrowLeft, ArrowUpRight, Cpu, Film, Gamepad2, Instagram, Play, Trophy, Youtube } from "lucide-react";
...
export default function LetsPlay() {
  ...
  return <div className="page-shell project-detail letsplay-detail"><SiteHeader /><main>
    <section className="detail-hero detail-hero--letsplay-surface" aria-labelledby="letsplay-title"><div className="detail-hero-overlay" /><span className="detail-hero-texture" aria-hidden="true" /><div className="letsplay-hero-grid" aria-hidden="true" /><div className="letsplay-hero-glyphs" aria-hidden="true"><span className="letsplay-hero-glyph letsplay-hero-glyph--game"><Gamepad2 size={23} /><b>PLAY / 01</b></span><span className="letsplay-hero-glyph letsplay-hero-glyph--tech"><Cpu size={21} /><b>TECH</b></span><span className="letsplay-hero-glyph letsplay-hero-glyph--film"><Film size={20} /><b>SCREEN</b></span><span className="letsplay-hero-glyph letsplay-hero-glyph--trophy"><Trophy size={21} /><b>LEVEL UP</b></span></div><div className="letsplay-hero-pixels" aria-hidden="true"><i /><i /><i /><i /><i /><i /></div><div className="iris-eye-orbit iris-eye-hero" aria-hidden="true"><i /><i /><i /></div><div className="detail-hero-copy"><Link className="back-link" href="/projets"><ArrowLeft size={16} /> Tous les projets</Link><p>01 / Let’s Play × Algérie Télécom</p><h1 id="letsplay-title">La pop culture<br />se joue aussi <em>sur le terrain.</em></h1><span>GAMING · TECH · E-SPORT · CINÉMA</span></div><div className="detail-project-brand detail-project-brand--letsplay"><img src={brand.logo} alt={brand.alt} /></div><div className="detail-stamp">LP<i>IRIS / 01</i></div></section>
