...
export default function Agency() {
  return <div className="page-shell"><SiteHeader /><main>
    <section className="page-hero page-hero-agency" aria-labelledby="agency-title"><div className="page-hero-photo" /><div className="page-hero-shade" /><div className="page-hero-ray" /><div className="iris-eye-orbit iris-eye-hero" aria-hidden="true"><i /><i /><i /></div><div className="page-hero-inner"><p className="eyebrow light-eyebrow">01 / L’agence</p><h1 id="agency-title">Les bonnes idées<br />ont besoin de <em>présence.</em></h1><p>Depuis Alger, Iris Studio accompagne les marques au moment où la réflexion doit devenir une action tangible.</p></div><div className="page-hero-index">AGENCE / 36.75°</div><div className="agency-hero-dossier">Cadre de méthode<br /><span>Illustration éditoriale / 01</span></div></section>
    ...
    <section className="proof-section section-pad"><div><p className="eyebrow">Trajectoires partagées</p><h2 className="display-title">Des marques qui nous font <em>confiance.</em></h2></div><div className="proof-names">{["Philip Morris International", "Coca-Cola", "LG", "Epiroc", "Ferrero", "Ooredoo", "Ifri"].map((name, index) => <span key={name}><i>{String(index + 1).padStart(2, "0")}</i>{name}</span>)}</div></section>
